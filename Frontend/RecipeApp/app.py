...
def home():
    ...
    return render_template('foodrecipes.php', recipes=[], search_query='')
...
def index():
    if request.method == 'POST':
        ...
        return render_template('foodrecipes.php', recipes=recipes, search_query=query)
    ...
    return render_template('foodrecipes.php', recipes=recipes, search_query=decoded_search_query)
